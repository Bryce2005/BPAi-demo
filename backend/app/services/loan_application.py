...
#         # train model
#         X_train, X_test, y_train, y_test = ls_train_test_split(self.processed_df)
...
#         # Note: Removed duplicate prediction call
...
#         lime_features = []
#         for name, weight in lime_list[:5]:  # Top 10 features
