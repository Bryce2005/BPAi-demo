...
// import { Upload, FileText, Package, AlertCircle, CheckCircle, XCircle, FileCheck, FileX, Download, Mail, Send, Settings } from 'lucide-react';
...
//     if (!applicationDetails || rejectedIds.length === 0) return;
...
//       const emailPromises = rejectedIds.map(async (applicationId) => {
//         const details = applicationDetails[applicationId];
//         if (!details || !details.email) return null;
        
//         const emailContent = generateEmailContent(applicationId);
        
//         // Simulate API call to email service
//         return new Promise((resolve) => {
//           setTimeout(() => {
//             console.log(`Email sent to ${details.email} for application ${applicationId}`);
...
//       setMessage({
//         message: `Successfully sent automated emails to ${rejectedIds.length} applicants with invalid documents.`,
//         type: 'success'
//       });
//     } catch (error) {
//       console.error('Error sending emails:', error);
//       setMessage({
//         message: 'Failed to send some or all automated emails. Please try again.',
//         type: 'error'
//       });
//     } finally {
